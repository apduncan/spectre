...
public class QuartetWeights extends Triplet<Double> {
    ...
    public QuartetWeights(Quad q1, Quad q2, double weight) {
        this(0.0, 0.0, 0.0);
     ...
     */
    public void update(Quad q1, Quad q2, double newW) {
     ...
     */
    public double selectWeight(Quad sorted, Quad unsorted) {
    ...
    public QuartetWeights permute(int t1, int t2, int t3, int t4) {
        ...
        // Sort taxa ascending
        int[] ta = new SpectreQuad(t1, t2, t3, t4).createSortedCopy().toIntArray();
