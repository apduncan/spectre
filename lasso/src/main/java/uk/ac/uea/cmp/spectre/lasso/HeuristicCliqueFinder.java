...
public class HeuristicCliqueFinder extends CliqueFinder {
     ...
     * uk.ac.uea.cmp.spectre.lasso.LassoOptions defines a number of times to attempt growing a clique.
     * Largest clique located is returned, ties broken randomly.
     * @param graph Graph to search in. For uk.ac.uea.cmp.spectre.lasso.Lasso, delete all non-minimal edgeweights first.
